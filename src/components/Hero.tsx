      ...
      {mobile ?
        <div className="flex xs:flex-col items-center justify-center sm:justify-between w-screen xs:h-5/6 sm:h-1/2 my-20">
          <div className="flex xs:flex-col items-center xs:w-5/5 align-center justify-evenly h-100 ">
            ...
            <button className="bg-yellow-400  w-button text-white py-3 px-5 rounded">{data.cta}</button>
          </div>
          <small className="text-center py-5">{data.content}</small>
        </div>
        :

        <div className="flex justify-between w-screen xs:h-5/6 sm:h-1/2 my-20 ">
          <div className="flex xs:flex-col xs:w-3/5 md:w-2/5 justify-evenly h-100 ">
            <h1 className="text-blue text-4xl font-bold ">{data.header}</h1>
